...
<!-- Built: 2026-02-22T22:34:04.652Z -->
...
Key colors: primary=#00ff9f, background=#0a0a0f, secondary=#00d4ff
Typography: 'JetBrains Mono', 'Fira Code', monospace
Constraints: dark_mode=true, high_contrast=true, animations=subtle-glow, typography_feel=monospace-tech, color_palette=neon-on-dark
...
| `USER.md` | Static | Profile of the user. Preferences, communication style, autonomy level, domain context. Updated by the user or during `/idea`. |
...
- User preferences ("user prefers co-pilot autonomy level")
...
<!-- Context budget: 8186/80000 tokens. 9 full, 0 truncated -->
