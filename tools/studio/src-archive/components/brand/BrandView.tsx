  ...
  return (
    <div style={{ flex: 1, padding: 28, gap: 24, overflow: "scroll", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        <span style={{ fontSize: 28, fontWeight: 700, letterSpacing: -0.5, color: "var(--text)" }}>
          Brand & Design
        </span>
    ...
    <div style={{
            ...
            <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
              {t.font_body && (
                <div style={{ textAlign: "center" }}>
                  ...
                  <div style={{ fontFamily: "var(--font)", fontSize: 11, color: "var(--text-secondary)" }}>{t.font_body}</div>
                </div>
              )}
              {t.font_heading && t.font_heading !== t.font_body && (
                <div style={{ textAlign: "center" }}>
                  ...
                  <div style={{ fontFamily: "var(--font)", fontSize: 11, color: "var(--text-secondary)" }}>{t.font_heading}</div>
                </div>
              )}
              {t.font_mono && (
                <div style={{ textAlign: "center" }}>
                  ...
                  <div style={{ fontFamily: "var(--font)", fontSize: 11, color: "var(--text-secondary)" }}>{t.font_mono}</div>
                </div>
              )}
            </div>
          </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
          ...
          {hasDarkToggle && (
            <div style={{ display: "flex", borderRadius: 6, overflow: "hidden", border: "1px solid var(--border)" }}>
              <button onClick={() => setShowDarkPalette(false)} style={{
              ...
              <button onClick={() => setShowDarkPalette(true)} style={{
                padding: "3px 10px", border: "none", cursor: "pointer",
                fontFamily: "var(--font)", fontSize: 10, fontWeight: 500,
                backgroundColor: showDarkPalette ? "var(--accent)" : "var(--bg)",
                color: showDarkPalette ? "#0a0a0f" : "var(--text-muted)",
        ...
        <div style={{ display: "flex", gap: 28, flexWrap: "wrap" }}>
          {colorCircles.map(({ hex, label }) => (
            <div key={label} style={{ textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "var(--font)", fontSize: 11, fontWeight: 500, color: "var(--text-secondary)", marginBottom: 2 }}>{label}</div>
              <div style={{ fontFamily: "var(--font-mono, var(--font))", fontSize: 10, color: "var(--text-muted)", textTransform: "uppercase" }}>{hex}</div>
            </div>
          ))}
        </div>
      </div>
            ...
            {brand.components.button?.primary && (() => {
              ...
              return (
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  <div style={{
                    backgroundColor: btn.backgroundColor, color: btn.color,
                    borderRadius: btn.borderRadius || "8px", padding: btn.padding || "10px 20px",
                    fontSize: btn.fontSize || "14px", fontWeight: btn.fontWeight || "600",
                    fontFamily: "var(--font)",
                    border: btn.border && !btn.border.startsWith("0px") ? btn.border : "none",
                    boxShadow: btn.boxShadow || "none", display: "inline-block", whiteSpace: "nowrap" as const,
                  }}>Primary</div>
                  <div style={{ fontFamily: "var(--font-mono, var(--font))", fontSize: 9, color: "var(--text-muted)" }}>r: {btn.borderRadius}</div>
                </div>
              );
            })()}
            ...
            {brand.components.card && (() => {
              ...
              return (
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  <div style={{
                    backgroundColor: card.backgroundColor, borderRadius: card.borderRadius || "12px",
                    padding: "16px 20px",
                    border: card.border && !card.border.startsWith("0px") ? card.border : "1px solid var(--border)",
                    boxShadow: card.boxShadow || "none",
                    width: 120, minHeight: 64, fontFamily: "var(--font)", fontSize: 10, color: "var(--text-muted)",
                    display: "flex", alignItems: "center", justifyContent: "center",
                  }}>Card</div>
                  <div style={{ fontFamily: "var(--font-mono, var(--font))", fontSize: 9, color: "var(--text-muted)" }}>r: {card.borderRadius}</div>
                </div>
              );
            })()}
              ...
              return (
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  <input disabled placeholder="Input" style={{
                    backgroundColor: inp.backgroundColor, borderRadius: inp.borderRadius || "8px",
                    padding: inp.padding || "10px 14px", border: inp.border || "1px solid var(--border)",
                    fontSize: inp.fontSize || "14px", color: inp.color || "var(--text)",
                    fontFamily: "var(--font)", width: 140, outline: "none",
                  }} />
                </div>
              );
            })()}
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            {Object.entries(brand.shadows).map(([size, value]) => (
              <div key={size} style={{ textAlign: "center" }}>
                <div style={{
                  width: 52, height: 52, borderRadius: 8, backgroundColor: "var(--bg-card)",
                  boxShadow: value as string, margin: "0 auto 8px", border: "1px solid var(--border)",
                }} />
            ...
            {Object.entries(t.type_scale).map(([level, vals]: [string, any]) => (
              <div key={level} style={{ display: "flex", alignItems: "baseline", gap: 12 }}>
                ...
                <div style={{
                  ...
                  fontSize: vals.fontSize, fontWeight: vals.fontWeight, lineHeight: vals.lineHeight,
                ...
                <div style={{ fontFamily: "var(--font-mono, var(--font))", fontSize: 9, color: "var(--text-muted)", flexShrink: 0 }}>
      ...
      {t.font_files?.length > 0 && (
        <div style={{
          ...
          display: "flex", alignItems: "center", gap: 8, fontFamily: "var(--font)", fontSize: 11,
        }}>
          ...
          {t.font_face_css && (
            <span style={{ color: "var(--text-muted)", marginLeft: 8 }}>+ @font-face CSS ready</span>
          )}
        </div>
      )}
          ...
          {lang.lang && (
            <div>
              ...
              <div style={detailValue}>
                {lang.lang_name}
                {lang.dir === "rtl" && <span style={{ color: "var(--text-muted)", fontSize: 11 }}> (RTL)</span>}
              </div>
            </div>
          )}
          {c.is_dark_mode != null && (
          ...
          {colorCircles.map(({ hex, label }) => (
            <div key={label} style={{ textAlign: "center" }}>
              <div style={{
                ...
                border: isLight(hex) ? "1px solid var(--border)" : "none", margin: "0 auto 6px",
              }} />
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div style={{
          fontFamily: "var(--font)", fontSize: 12, color: "var(--text-secondary)", lineHeight: 1.4,
        }}>{desc}</div>
      </div>
    </div>
  );
