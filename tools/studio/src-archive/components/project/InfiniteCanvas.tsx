  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={fitAll}
          className="w-7 h-7 rounded-md flex items-center justify-center text-text-muted hover:text-text transition-colors cursor-pointer"
          style={{ backgroundColor: "var(--color-bg-card, var(--bg-card))", border: "1px solid var(--color-border, var(--border))" }}
          title="Fit all"
        >
