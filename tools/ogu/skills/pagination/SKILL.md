---
name: pagination
description: Pagination expertise for building robust, scalable backend services and APIs. Use when implementing pagination, designing APIs, or building server-side features. Triggers: "pagination", "implement pagination", "build pagination", "backend pagination".
---
...
- Working on pagination tasks
- Reviewing or improving existing pagination implementations
- Troubleshooting issues related to pagination
- Setting up or configuring pagination from scratch
