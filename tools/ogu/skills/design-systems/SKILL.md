---
name: design-systems
description: Design systems expertise for low-level systems programming, embedded development, and performance-critical code. Use when implementing design systems, working with hardware interfaces, or optimizing system-level code. Triggers: "design systems", "implement design-systems", "systems design-systems", "low-level design-systems".
---
...
- Working on design systems tasks
- Reviewing or improving existing design systems implementations
- Troubleshooting issues related to design systems
- Setting up or configuring design systems from scratch
