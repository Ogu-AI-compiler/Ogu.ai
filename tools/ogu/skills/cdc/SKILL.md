---
name: cdc
description: Cdc expertise for building robust, scalable backend services and APIs. Use when implementing cdc, designing APIs, or building server-side features. Triggers: "cdc", "implement cdc", "build cdc", "backend cdc".
---
...
- Working on cdc tasks
- Reviewing or improving existing cdc implementations
- Troubleshooting issues related to cdc
- Setting up or configuring cdc from scratch
