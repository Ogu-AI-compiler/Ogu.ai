...
description: Architecture patterns expertise for building reliable distributed systems with strong consistency guarantees. Use when designing architecture patterns, handling distributed transactions, or ensuring consistency across services. Triggers: "architecture patterns", "design architecture-patterns", "implement architecture-patterns", "distributed architecture-patterns".
---
...
- Working on architecture patterns tasks
- Reviewing or improving existing architecture patterns implementations
- Troubleshooting issues related to architecture patterns
- Setting up or configuring architecture patterns from scratch
