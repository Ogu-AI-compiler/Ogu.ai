...
description: Chaos engineering expertise for building robust, scalable backend services and APIs. Use when implementing chaos engineering, designing APIs, or building server-side features. Triggers: "chaos engineering", "implement chaos engineering", "build chaos-engineering", "backend chaos-engineering".
---
...
- Working on chaos engineering tasks
- Reviewing or improving existing chaos engineering implementations
- Troubleshooting issues related to chaos engineering
- Setting up or configuring chaos engineering from scratch
