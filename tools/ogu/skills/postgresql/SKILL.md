---
name: postgresql
description: Postgresql expertise for building robust, scalable backend services and APIs. Use when implementing postgresql, designing APIs, or building server-side features. Triggers: "postgresql", "implement postgresql", "build postgresql", "backend postgresql".
---
...
- Working on postgresql tasks
- Reviewing or improving existing postgresql implementations
- Troubleshooting issues related to postgresql
- Setting up or configuring postgresql from scratch
