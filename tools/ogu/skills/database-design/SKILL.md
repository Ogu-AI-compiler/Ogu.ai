...
description: Database design expertise for building robust, scalable backend services and APIs. Use when implementing database design, designing APIs, or building server-side features. Triggers: "database design", "implement database design", "build database-design", "backend database-design".
---
...
- Working on database design tasks
- Reviewing or improving existing database design implementations
- Troubleshooting issues related to database design
- Setting up or configuring database design from scratch
