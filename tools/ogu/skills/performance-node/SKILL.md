...
description: Performance node expertise for building robust, scalable backend services and APIs. Use when implementing performance node, designing APIs, or building server-side features. Triggers: "performance node", "implement performance node", "build performance-node", "backend performance-node".
---
...
- Working on performance node tasks
- Reviewing or improving existing performance node implementations
- Troubleshooting issues related to performance node
- Setting up or configuring performance node from scratch
