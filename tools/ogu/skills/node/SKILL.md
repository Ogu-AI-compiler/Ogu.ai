---
name: node
description: Node expertise for building robust, scalable backend services and APIs. Use when implementing node, designing APIs, or building server-side features. Triggers: "node", "implement node", "build node", "backend node".
---
...
- Working on node tasks
- Reviewing or improving existing node implementations
- Troubleshooting issues related to node
- Setting up or configuring node from scratch
