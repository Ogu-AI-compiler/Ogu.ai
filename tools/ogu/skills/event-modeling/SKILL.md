---
name: event-modeling
description: Event modeling expertise for building reliable distributed systems with strong consistency guarantees. Use when designing event modeling, handling distributed transactions, or ensuring consistency across services. Triggers: "event modeling", "design event-modeling", "implement event-modeling", "distributed event-modeling".
---
...
- Working on event modeling tasks
- Reviewing or improving existing event modeling implementations
- Troubleshooting issues related to event modeling
- Setting up or configuring event modeling from scratch
