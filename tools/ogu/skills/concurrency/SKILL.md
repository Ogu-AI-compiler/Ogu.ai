---
name: concurrency
description: Concurrency expertise for low-level systems programming, embedded development, and performance-critical code. Use when implementing concurrency, working with hardware interfaces, or optimizing system-level code. Triggers: "concurrency", "implement concurrency", "systems concurrency", "low-level concurrency".
---
...
- Working on concurrency tasks
- Reviewing or improving existing concurrency implementations
- Troubleshooting issues related to concurrency
- Setting up or configuring concurrency from scratch
