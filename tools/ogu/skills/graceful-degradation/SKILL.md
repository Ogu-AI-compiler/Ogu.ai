...
description: Graceful degradation expertise for building reliable distributed systems with strong consistency guarantees. Use when designing graceful degradation, handling distributed transactions, or ensuring consistency across services. Triggers: "graceful degradation", "design graceful-degradation", "implement graceful-degradation", "distributed graceful-degradation".
---
...
- Working on graceful degradation tasks
- Reviewing or improving existing graceful degradation implementations
- Troubleshooting issues related to graceful degradation
- Setting up or configuring graceful degradation from scratch
