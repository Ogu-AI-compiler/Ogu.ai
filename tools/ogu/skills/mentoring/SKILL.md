---
name: mentoring
description: Mentoring expertise for building robust, scalable backend services and APIs. Use when implementing mentoring, designing APIs, or building server-side features. Triggers: "mentoring", "implement mentoring", "build mentoring", "backend mentoring".
---
...
- Working on mentoring tasks
- Reviewing or improving existing mentoring implementations
- Troubleshooting issues related to mentoring
- Setting up or configuring mentoring from scratch
