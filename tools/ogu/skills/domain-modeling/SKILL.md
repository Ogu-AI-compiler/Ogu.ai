...
description: Domain modeling expertise for building reliable distributed systems with strong consistency guarantees. Use when designing domain modeling, handling distributed transactions, or ensuring consistency across services. Triggers: "domain modeling", "design domain-modeling", "implement domain-modeling", "distributed domain-modeling".
---
...
- Working on domain modeling tasks
- Reviewing or improving existing domain modeling implementations
- Troubleshooting issues related to domain modeling
- Setting up or configuring domain modeling from scratch
