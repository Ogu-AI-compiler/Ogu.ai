---
name: tcp-ip
description: Tcp ip expertise for low-level systems programming, embedded development, and performance-critical code. Use when implementing tcp ip, working with hardware interfaces, or optimizing system-level code. Triggers: "tcp ip", "implement tcp-ip", "systems tcp-ip", "low-level tcp-ip".
---
...
- Working on tcp ip tasks
- Reviewing or improving existing tcp ip implementations
- Troubleshooting issues related to tcp ip
- Setting up or configuring tcp ip from scratch
