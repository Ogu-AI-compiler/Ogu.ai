---
name: rtos
description: Rtos expertise for low-level systems programming, embedded development, and performance-critical code. Use when implementing rtos, working with hardware interfaces, or optimizing system-level code. Triggers: "rtos", "implement rtos", "systems rtos", "low-level rtos".
---
...
- Working on rtos tasks
- Reviewing or improving existing rtos implementations
- Troubleshooting issues related to rtos
- Setting up or configuring rtos from scratch
