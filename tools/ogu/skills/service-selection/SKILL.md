...
description: Service selection expertise for building robust, scalable backend services and APIs. Use when implementing service selection, designing APIs, or building server-side features. Triggers: "service selection", "implement service selection", "build service-selection", "backend service-selection".
---
...
- Working on service selection tasks
- Reviewing or improving existing service selection implementations
- Troubleshooting issues related to service selection
- Setting up or configuring service selection from scratch
