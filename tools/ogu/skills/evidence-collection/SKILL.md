...
description: Evidence collection expertise for building robust, scalable backend services and APIs. Use when implementing evidence collection, designing APIs, or building server-side features. Triggers: "evidence collection", "implement evidence collection", "build evidence-collection", "backend evidence-collection".
---
...
- Working on evidence collection tasks
- Reviewing or improving existing evidence collection implementations
- Troubleshooting issues related to evidence collection
- Setting up or configuring evidence collection from scratch
