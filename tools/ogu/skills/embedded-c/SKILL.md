---
name: embedded-c
description: Embedded c expertise for low-level systems programming, embedded development, and performance-critical code. Use when implementing embedded c, working with hardware interfaces, or optimizing system-level code. Triggers: "embedded c", "implement embedded-c", "systems embedded-c", "low-level embedded-c".
---
...
- Working on embedded c tasks
- Reviewing or improving existing embedded c implementations
- Troubleshooting issues related to embedded c
- Setting up or configuring embedded c from scratch
