...
description: Event management expertise for building reliable distributed systems with strong consistency guarantees. Use when designing event management, handling distributed transactions, or ensuring consistency across services. Triggers: "event management", "design event-management", "implement event-management", "distributed event-management".
---
...
- Working on event management tasks
- Reviewing or improving existing event management implementations
- Troubleshooting issues related to event management
- Setting up or configuring event management from scratch
