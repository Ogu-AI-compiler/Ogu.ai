---
name: entity-design
description: Entity design expertise for building robust, scalable backend services and APIs. Use when implementing entity design, designing APIs, or building server-side features. Triggers: "entity design", "implement entity design", "build entity-design", "backend entity-design".
---
...
- Working on entity design tasks
- Reviewing or improving existing entity design implementations
- Troubleshooting issues related to entity design
- Setting up or configuring entity design from scratch
