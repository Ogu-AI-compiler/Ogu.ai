---
name: hooks
description: Hooks expertise for building robust, scalable backend services and APIs. Use when implementing hooks, designing APIs, or building server-side features. Triggers: "hooks", "implement hooks", "build hooks", "backend hooks".
---
...
- Working on hooks tasks
- Reviewing or improving existing hooks implementations
- Troubleshooting issues related to hooks
- Setting up or configuring hooks from scratch
