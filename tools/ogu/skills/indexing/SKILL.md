---
name: indexing
description: Indexing expertise for building robust, scalable backend services and APIs. Use when implementing indexing, designing APIs, or building server-side features. Triggers: "indexing", "implement indexing", "build indexing", "backend indexing".
---
...
- Working on indexing tasks
- Reviewing or improving existing indexing implementations
- Troubleshooting issues related to indexing
- Setting up or configuring indexing from scratch
