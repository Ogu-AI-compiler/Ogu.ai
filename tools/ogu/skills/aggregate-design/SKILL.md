...
description: Aggregate design expertise for building reliable distributed systems with strong consistency guarantees. Use when designing aggregate design, handling distributed transactions, or ensuring consistency across services. Triggers: "aggregate design", "design aggregate-design", "implement aggregate-design", "distributed aggregate-design".
---
...
- Working on aggregate design tasks
- Reviewing or improving existing aggregate design implementations
- Troubleshooting issues related to aggregate design
- Setting up or configuring aggregate design from scratch
