...
description: Dependency management expertise for building robust, scalable backend services and APIs. Use when implementing dependency management, designing APIs, or building server-side features. Triggers: "dependency management", "implement dependency management", "build dependency-management", "backend dependency-management".
---
...
- Working on dependency management tasks
- Reviewing or improving existing dependency management implementations
- Troubleshooting issues related to dependency management
- Setting up or configuring dependency management from scratch
