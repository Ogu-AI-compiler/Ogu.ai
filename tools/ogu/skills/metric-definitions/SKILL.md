...
description: Metric definitions expertise for building robust, scalable backend services and APIs. Use when implementing metric definitions, designing APIs, or building server-side features. Triggers: "metric definitions", "implement metric definitions", "build metric-definitions", "backend metric-definitions".
---
...
- Working on metric definitions tasks
- Reviewing or improving existing metric definitions implementations
- Troubleshooting issues related to metric definitions
- Setting up or configuring metric definitions from scratch
