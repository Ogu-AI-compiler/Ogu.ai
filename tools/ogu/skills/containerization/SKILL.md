...
description: Containerization expertise for building robust, scalable backend services and APIs. Use when implementing containerization, designing APIs, or building server-side features. Triggers: "containerization", "implement containerization", "build containerization", "backend containerization".
---
...
- Working on containerization tasks
- Reviewing or improving existing containerization implementations
- Troubleshooting issues related to containerization
- Setting up or configuring containerization from scratch
