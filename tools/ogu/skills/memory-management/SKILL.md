...
description: Memory management expertise for low-level systems programming, embedded development, and performance-critical code. Use when implementing memory management, working with hardware interfaces, or optimizing system-level code. Triggers: "memory management", "implement memory-management", "systems memory-management", "low-level memory-management".
---
...
- Working on memory management tasks
- Reviewing or improving existing memory management implementations
- Troubleshooting issues related to memory management
- Setting up or configuring memory management from scratch
