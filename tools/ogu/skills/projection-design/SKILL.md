...
description: Projection design expertise for building robust, scalable backend services and APIs. Use when implementing projection design, designing APIs, or building server-side features. Triggers: "projection design", "implement projection design", "build projection-design", "backend projection-design".
---
...
- Working on projection design tasks
- Reviewing or improving existing projection design implementations
- Troubleshooting issues related to projection design
- Setting up or configuring projection design from scratch
