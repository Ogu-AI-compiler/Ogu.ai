---
name: cqrs
description: Cqrs expertise for building reliable distributed systems with strong consistency guarantees. Use when designing cqrs, handling distributed transactions, or ensuring consistency across services. Triggers: "cqrs", "design cqrs", "implement cqrs", "distributed cqrs".
---
...
- Working on cqrs tasks
- Reviewing or improving existing cqrs implementations
- Troubleshooting issues related to cqrs
- Setting up or configuring cqrs from scratch
