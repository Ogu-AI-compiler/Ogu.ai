...
description: Evidence management expertise for building robust, scalable backend services and APIs. Use when implementing evidence management, designing APIs, or building server-side features. Triggers: "evidence management", "implement evidence management", "build evidence-management", "backend evidence-management".
---
...
- Working on evidence management tasks
- Reviewing or improving existing evidence management implementations
- Troubleshooting issues related to evidence management
- Setting up or configuring evidence management from scratch
