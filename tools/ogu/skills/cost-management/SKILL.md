...
description: Cost management expertise for building robust, scalable backend services and APIs. Use when implementing cost management, designing APIs, or building server-side features. Triggers: "cost management", "implement cost management", "build cost-management", "backend cost-management".
---
...
- Working on cost management tasks
- Reviewing or improving existing cost management implementations
- Troubleshooting issues related to cost management
- Setting up or configuring cost management from scratch
