---
name: postman
description: Postman expertise for building robust, scalable backend services and APIs. Use when implementing postman, designing APIs, or building server-side features. Triggers: "postman", "implement postman", "build postman", "backend postman".
---
...
- Working on postman tasks
- Reviewing or improving existing postman implementations
- Troubleshooting issues related to postman
- Setting up or configuring postman from scratch
