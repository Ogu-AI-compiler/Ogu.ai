...
description: Toil elimination expertise for building robust, scalable backend services and APIs. Use when implementing toil elimination, designing APIs, or building server-side features. Triggers: "toil elimination", "implement toil elimination", "build toil-elimination", "backend toil-elimination".
---
...
- Working on toil elimination tasks
- Reviewing or improving existing toil elimination implementations
- Troubleshooting issues related to toil elimination
- Setting up or configuring toil elimination from scratch
