---
name: switching
description: Switching expertise for building robust, scalable backend services and APIs. Use when implementing switching, designing APIs, or building server-side features. Triggers: "switching", "implement switching", "build switching", "backend switching".
---
...
- Working on switching tasks
- Reviewing or improving existing switching implementations
- Troubleshooting issues related to switching
- Setting up or configuring switching from scratch
