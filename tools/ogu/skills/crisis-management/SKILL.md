...
description: Crisis management expertise for building robust, scalable backend services and APIs. Use when implementing crisis management, designing APIs, or building server-side features. Triggers: "crisis management", "implement crisis management", "build crisis-management", "backend crisis-management".
---
...
- Working on crisis management tasks
- Reviewing or improving existing crisis management implementations
- Troubleshooting issues related to crisis management
- Setting up or configuring crisis management from scratch
