---
name: vpn
description: Vpn expertise for building robust, scalable backend services and APIs. Use when implementing vpn, designing APIs, or building server-side features. Triggers: "vpn", "implement vpn", "build vpn", "backend vpn".
---
...
- Working on vpn tasks
- Reviewing or improving existing vpn implementations
- Troubleshooting issues related to vpn
- Setting up or configuring vpn from scratch
