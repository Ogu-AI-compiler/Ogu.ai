---
name: api-contracts
description: Api contracts expertise for building robust, scalable backend services and APIs. Use when implementing api contracts, designing APIs, or building server-side features. Triggers: "api contracts", "implement api contracts", "build api-contracts", "backend api-contracts".
---
...
- Working on api contracts tasks
- Reviewing or improving existing api contracts implementations
- Troubleshooting issues related to api contracts
- Setting up or configuring api contracts from scratch
