---
name: streaming
description: Streaming expertise for building robust, scalable backend services and APIs. Use when implementing streaming, designing APIs, or building server-side features. Triggers: "streaming", "implement streaming", "build streaming", "backend streaming".
---
...
- Working on streaming tasks
- Reviewing or improving existing streaming implementations
- Troubleshooting issues related to streaming
- Setting up or configuring streaming from scratch
