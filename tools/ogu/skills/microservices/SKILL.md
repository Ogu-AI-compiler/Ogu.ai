---
name: microservices
description: Microservices expertise for building robust, scalable backend services and APIs. Use when implementing microservices, designing APIs, or building server-side features. Triggers: "microservices", "implement microservices", "build microservices", "backend microservices".
---
...
- Working on microservices tasks
- Reviewing or improving existing microservices implementations
- Troubleshooting issues related to microservices
- Setting up or configuring microservices from scratch
