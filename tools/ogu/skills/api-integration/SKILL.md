...
description: Api integration expertise for building robust, scalable backend services and APIs. Use when implementing api integration, designing APIs, or building server-side features. Triggers: "api integration", "implement api integration", "build api-integration", "backend api-integration".
---
...
- Working on api integration tasks
- Reviewing or improving existing api integration implementations
- Troubleshooting issues related to api integration
- Setting up or configuring api integration from scratch
