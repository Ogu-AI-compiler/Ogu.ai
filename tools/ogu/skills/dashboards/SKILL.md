---
name: dashboards
description: Dashboards expertise for building robust, scalable backend services and APIs. Use when implementing dashboards, designing APIs, or building server-side features. Triggers: "dashboards", "implement dashboards", "build dashboards", "backend dashboards".
---
...
- Working on dashboards tasks
- Reviewing or improving existing dashboards implementations
- Troubleshooting issues related to dashboards
- Setting up or configuring dashboards from scratch
