---
name: architecture
description: Architecture expertise for building robust, scalable backend services and APIs. Use when implementing architecture, designing APIs, or building server-side features. Triggers: "architecture", "implement architecture", "build architecture", "backend architecture".
---
...
- Working on architecture tasks
- Reviewing or improving existing architecture implementations
- Troubleshooting issues related to architecture
- Setting up or configuring architecture from scratch
