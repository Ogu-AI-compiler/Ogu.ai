...
description: Program analysis expertise for low-level systems programming, embedded development, and performance-critical code. Use when implementing program analysis, working with hardware interfaces, or optimizing system-level code. Triggers: "program analysis", "implement program-analysis", "systems program-analysis", "low-level program-analysis".
---
...
- Working on program analysis tasks
- Reviewing or improving existing program analysis implementations
- Troubleshooting issues related to program analysis
- Setting up or configuring program analysis from scratch
