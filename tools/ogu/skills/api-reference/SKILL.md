---
name: api-reference
description: Api reference expertise for building robust, scalable backend services and APIs. Use when implementing api reference, designing APIs, or building server-side features. Triggers: "api reference", "implement api reference", "build api-reference", "backend api-reference".
---
...
- Working on api reference tasks
- Reviewing or improving existing api reference implementations
- Troubleshooting issues related to api reference
- Setting up or configuring api reference from scratch
