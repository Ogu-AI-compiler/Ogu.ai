---
name: system-design
description: System design expertise for building robust, scalable backend services and APIs. Use when implementing system design, designing APIs, or building server-side features. Triggers: "system design", "implement system design", "build system-design", "backend system-design".
---
...
- Working on system design tasks
- Reviewing or improving existing system design implementations
- Troubleshooting issues related to system design
- Setting up or configuring system design from scratch
