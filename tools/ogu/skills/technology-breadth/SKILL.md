...
description: Technology breadth expertise for building robust, scalable backend services and APIs. Use when implementing technology breadth, designing APIs, or building server-side features. Triggers: "technology breadth", "implement technology breadth", "build technology-breadth", "backend technology-breadth".
---
...
- Working on technology breadth tasks
- Reviewing or improving existing technology breadth implementations
- Troubleshooting issues related to technology breadth
- Setting up or configuring technology breadth from scratch
