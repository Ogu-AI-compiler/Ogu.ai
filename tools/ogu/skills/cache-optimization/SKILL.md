...
description: Cache optimization expertise for building robust, scalable backend services and APIs. Use when implementing cache optimization, designing APIs, or building server-side features. Triggers: "cache optimization", "implement cache optimization", "build cache-optimization", "backend cache-optimization".
---
...
- Working on cache optimization tasks
- Reviewing or improving existing cache optimization implementations
- Troubleshooting issues related to cache optimization
- Setting up or configuring cache optimization from scratch
