...
description: Database architecture expertise for building robust, scalable backend services and APIs. Use when implementing database architecture, designing APIs, or building server-side features. Triggers: "database architecture", "implement database architecture", "build database-architecture", "backend database-architecture".
---
...
- Working on database architecture tasks
- Reviewing or improving existing database architecture implementations
- Troubleshooting issues related to database architecture
- Setting up or configuring database architecture from scratch
