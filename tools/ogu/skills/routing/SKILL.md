---
name: routing
description: Routing expertise for building robust, scalable backend services and APIs. Use when implementing routing, designing APIs, or building server-side features. Triggers: "routing", "implement routing", "build routing", "backend routing".
---
...
- Working on routing tasks
- Reviewing or improving existing routing implementations
- Troubleshooting issues related to routing
- Setting up or configuring routing from scratch
