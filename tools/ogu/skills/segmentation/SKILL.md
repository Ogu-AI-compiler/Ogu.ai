---
name: segmentation
description: Segmentation expertise for building robust, scalable backend services and APIs. Use when implementing segmentation, designing APIs, or building server-side features. Triggers: "segmentation", "implement segmentation", "build segmentation", "backend segmentation".
---
...
- Working on segmentation tasks
- Reviewing or improving existing segmentation implementations
- Troubleshooting issues related to segmentation
- Setting up or configuring segmentation from scratch
