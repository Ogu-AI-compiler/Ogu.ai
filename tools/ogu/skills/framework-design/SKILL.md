...
description: Framework design expertise for building robust, scalable backend services and APIs. Use when implementing framework design, designing APIs, or building server-side features. Triggers: "framework design", "implement framework design", "build framework-design", "backend framework-design".
---
...
- Working on framework design tasks
- Reviewing or improving existing framework design implementations
- Troubleshooting issues related to framework design
- Setting up or configuring framework design from scratch
