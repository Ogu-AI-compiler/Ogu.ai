...
description: Interrupt handling expertise for low-level systems programming, embedded development, and performance-critical code. Use when implementing interrupt handling, working with hardware interfaces, or optimizing system-level code. Triggers: "interrupt handling", "implement interrupt-handling", "systems interrupt-handling", "low-level interrupt-handling".
---
...
- Working on interrupt handling tasks
- Reviewing or improving existing interrupt handling implementations
- Troubleshooting issues related to interrupt handling
- Setting up or configuring interrupt handling from scratch
