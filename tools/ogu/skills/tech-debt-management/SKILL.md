...
description: Tech debt management expertise for building robust, scalable backend services and APIs. Use when implementing tech debt management, designing APIs, or building server-side features. Triggers: "tech debt management", "implement tech debt management", "build tech-debt-management", "backend tech-debt-management".
---
...
- Working on tech debt management tasks
- Reviewing or improving existing tech debt management implementations
- Troubleshooting issues related to tech debt management
- Setting up or configuring tech debt management from scratch
