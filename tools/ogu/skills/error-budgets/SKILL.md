---
name: error-budgets
description: Error budgets expertise for building robust, scalable backend services and APIs. Use when implementing error budgets, designing APIs, or building server-side features. Triggers: "error budgets", "implement error budgets", "build error-budgets", "backend error-budgets".
---
...
- Working on error budgets tasks
- Reviewing or improving existing error budgets implementations
- Troubleshooting issues related to error budgets
- Setting up or configuring error budgets from scratch
