---
name: error-design
description: Error design expertise for building robust, scalable backend services and APIs. Use when implementing error design, designing APIs, or building server-side features. Triggers: "error design", "implement error design", "build error-design", "backend error-design".
---
...
- Working on error design tasks
- Reviewing or improving existing error design implementations
- Troubleshooting issues related to error design
- Setting up or configuring error design from scratch
