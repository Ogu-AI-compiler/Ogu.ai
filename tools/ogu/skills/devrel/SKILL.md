---
name: devrel
description: Devrel expertise for building robust, scalable backend services and APIs. Use when implementing devrel, designing APIs, or building server-side features. Triggers: "devrel", "implement devrel", "build devrel", "backend devrel".
---
...
- Working on devrel tasks
- Reviewing or improving existing devrel implementations
- Troubleshooting issues related to devrel
- Setting up or configuring devrel from scratch
