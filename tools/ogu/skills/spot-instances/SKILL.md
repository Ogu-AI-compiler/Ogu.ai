---
name: spot-instances
description: Spot instances expertise for building robust, scalable backend services and APIs. Use when implementing spot instances, designing APIs, or building server-side features. Triggers: "spot instances", "implement spot instances", "build spot-instances", "backend spot-instances".
---
...
- Working on spot instances tasks
- Reviewing or improving existing spot instances implementations
- Troubleshooting issues related to spot instances
- Setting up or configuring spot instances from scratch
