---
name: grpc
description: Grpc expertise for building robust, scalable backend services and APIs. Use when implementing grpc, designing APIs, or building server-side features. Triggers: "grpc", "implement grpc", "build grpc", "backend grpc".
---
...
- Working on grpc tasks
- Reviewing or improving existing grpc implementations
- Troubleshooting issues related to grpc
- Setting up or configuring grpc from scratch
