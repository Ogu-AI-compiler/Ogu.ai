---
name: opentelemetry
description: Opentelemetry expertise for building robust, scalable backend services and APIs. Use when implementing opentelemetry, designing APIs, or building server-side features. Triggers: "opentelemetry", "implement opentelemetry", "build opentelemetry", "backend opentelemetry".
---
...
- Working on opentelemetry tasks
- Reviewing or improving existing opentelemetry implementations
- Troubleshooting issues related to opentelemetry
- Setting up or configuring opentelemetry from scratch
