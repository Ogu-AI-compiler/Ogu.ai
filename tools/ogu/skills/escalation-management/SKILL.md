...
description: Escalation management expertise for building robust, scalable backend services and APIs. Use when implementing escalation management, designing APIs, or building server-side features. Triggers: "escalation management", "implement escalation management", "build escalation-management", "backend escalation-management".
---
...
- Working on escalation management tasks
- Reviewing or improving existing escalation management implementations
- Troubleshooting issues related to escalation management
- Setting up or configuring escalation management from scratch
