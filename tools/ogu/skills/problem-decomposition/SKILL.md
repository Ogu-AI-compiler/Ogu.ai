...
description: Problem decomposition expertise for building robust, scalable backend services and APIs. Use when implementing problem decomposition, designing APIs, or building server-side features. Triggers: "problem decomposition", "implement problem decomposition", "build problem-decomposition", "backend problem-decomposition".
---
...
- Working on problem decomposition tasks
- Reviewing or improving existing problem decomposition implementations
- Troubleshooting issues related to problem decomposition
- Setting up or configuring problem decomposition from scratch
