...
description: Assistive technology expertise for building robust, scalable backend services and APIs. Use when implementing assistive technology, designing APIs, or building server-side features. Triggers: "assistive technology", "implement assistive technology", "build assistive-technology", "backend assistive-technology".
---
...
- Working on assistive technology tasks
- Reviewing or improving existing assistive technology implementations
- Troubleshooting issues related to assistive technology
- Setting up or configuring assistive technology from scratch
