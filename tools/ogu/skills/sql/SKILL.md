---
name: sql
description: Sql expertise for building robust, scalable backend services and APIs. Use when implementing sql, designing APIs, or building server-side features. Triggers: "sql", "implement sql", "build sql", "backend sql".
---
...
- Working on sql tasks
- Reviewing or improving existing sql implementations
- Troubleshooting issues related to sql
- Setting up or configuring sql from scratch
