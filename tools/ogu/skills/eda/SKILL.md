---
name: eda
description: Eda expertise for building robust, scalable backend services and APIs. Use when implementing eda, designing APIs, or building server-side features. Triggers: "eda", "implement eda", "build eda", "backend eda".
---
...
- Working on eda tasks
- Reviewing or improving existing eda implementations
- Troubleshooting issues related to eda
- Setting up or configuring eda from scratch
