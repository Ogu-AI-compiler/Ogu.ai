---
name: consensus
description: Consensus expertise for building reliable distributed systems with strong consistency guarantees. Use when designing consensus, handling distributed transactions, or ensuring consistency across services. Triggers: "consensus", "design consensus", "implement consensus", "distributed consensus".
---
...
- Working on consensus tasks
- Reviewing or improving existing consensus implementations
- Troubleshooting issues related to consensus
- Setting up or configuring consensus from scratch
