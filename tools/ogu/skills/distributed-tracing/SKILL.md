...
description: Distributed tracing expertise for building reliable distributed systems with strong consistency guarantees. Use when designing distributed tracing, handling distributed transactions, or ensuring consistency across services. Triggers: "distributed tracing", "design distributed-tracing", "implement distributed-tracing", "distributed distributed-tracing".
---
...
- Working on distributed tracing tasks
- Reviewing or improving existing distributed tracing implementations
- Troubleshooting issues related to distributed tracing
- Setting up or configuring distributed tracing from scratch
