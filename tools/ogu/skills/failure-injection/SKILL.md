...
description: Failure injection expertise for building robust, scalable backend services and APIs. Use when implementing failure injection, designing APIs, or building server-side features. Triggers: "failure injection", "implement failure injection", "build failure-injection", "backend failure-injection".
---
...
- Working on failure injection tasks
- Reviewing or improving existing failure injection implementations
- Troubleshooting issues related to failure injection
- Setting up or configuring failure injection from scratch
