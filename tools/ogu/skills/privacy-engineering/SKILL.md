...
description: Privacy engineering expertise for building robust, scalable backend services and APIs. Use when implementing privacy engineering, designing APIs, or building server-side features. Triggers: "privacy engineering", "implement privacy engineering", "build privacy-engineering", "backend privacy-engineering".
---
...
- Working on privacy engineering tasks
- Reviewing or improving existing privacy engineering implementations
- Troubleshooting issues related to privacy engineering
- Setting up or configuring privacy engineering from scratch
