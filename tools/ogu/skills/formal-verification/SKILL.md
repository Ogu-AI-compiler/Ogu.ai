...
description: Formal verification expertise for low-level systems programming, embedded development, and performance-critical code. Use when implementing formal verification, working with hardware interfaces, or optimizing system-level code. Triggers: "formal verification", "implement formal-verification", "systems formal-verification", "low-level formal-verification".
---
...
- Working on formal verification tasks
- Reviewing or improving existing formal verification implementations
- Troubleshooting issues related to formal verification
- Setting up or configuring formal verification from scratch
