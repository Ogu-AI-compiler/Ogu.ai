---
name: event-storming
description: Event storming expertise for building reliable distributed systems with strong consistency guarantees. Use when designing event storming, handling distributed transactions, or ensuring consistency across services. Triggers: "event storming", "design event-storming", "implement event-storming", "distributed event-storming".
---
...
- Working on event storming tasks
- Reviewing or improving existing event storming implementations
- Troubleshooting issues related to event storming
- Setting up or configuring event storming from scratch
