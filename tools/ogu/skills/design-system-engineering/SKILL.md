...
description: Design system engineering expertise for building robust, scalable backend services and APIs. Use when implementing design system engineering, designing APIs, or building server-side features. Triggers: "design system engineering", "implement design system engineering", "build design-system-engineering", "backend design-system-engineering".
---
...
- Working on design system engineering tasks
- Reviewing or improving existing design system engineering implementations
- Troubleshooting issues related to design system engineering
- Setting up or configuring design system engineering from scratch
