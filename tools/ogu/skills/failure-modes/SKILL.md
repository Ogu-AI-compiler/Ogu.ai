---
name: failure-modes
description: Failure modes expertise for building robust, scalable backend services and APIs. Use when implementing failure modes, designing APIs, or building server-side features. Triggers: "failure modes", "implement failure modes", "build failure-modes", "backend failure-modes".
---
...
- Working on failure modes tasks
- Reviewing or improving existing failure modes implementations
- Troubleshooting issues related to failure modes
- Setting up or configuring failure modes from scratch
