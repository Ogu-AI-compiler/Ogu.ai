---
name: saga-design
description: Saga design expertise for building reliable distributed systems with strong consistency guarantees. Use when designing saga design, handling distributed transactions, or ensuring consistency across services. Triggers: "saga design", "design saga-design", "implement saga-design", "distributed saga-design".
---
...
- Working on saga design tasks
- Reviewing or improving existing saga design implementations
- Troubleshooting issues related to saga design
- Setting up or configuring saga design from scratch
