---
name: api-security
description: Api security expertise for building robust, scalable backend services and APIs. Use when implementing api security, designing APIs, or building server-side features. Triggers: "api security", "implement api security", "build api-security", "backend api-security".
---
...
- Working on api security tasks
- Reviewing or improving existing api security implementations
- Troubleshooting issues related to api security
- Setting up or configuring api security from scratch
