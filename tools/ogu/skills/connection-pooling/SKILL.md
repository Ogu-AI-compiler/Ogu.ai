...
description: Connection pooling expertise for building robust, scalable backend services and APIs. Use when implementing connection pooling, designing APIs, or building server-side features. Triggers: "connection pooling", "implement connection pooling", "build connection-pooling", "backend connection-pooling".
---
...
- Working on connection pooling tasks
- Reviewing or improving existing connection pooling implementations
- Troubleshooting issues related to connection pooling
- Setting up or configuring connection pooling from scratch
