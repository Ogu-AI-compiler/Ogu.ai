...
description: Integration design expertise for building robust, scalable backend services and APIs. Use when implementing integration design, designing APIs, or building server-side features. Triggers: "integration design", "implement integration design", "build integration-design", "backend integration-design".
---
...
- Working on integration design tasks
- Reviewing or improving existing integration design implementations
- Troubleshooting issues related to integration design
- Setting up or configuring integration design from scratch
