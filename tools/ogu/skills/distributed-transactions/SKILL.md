...
description: Distributed transactions expertise for building reliable distributed systems with strong consistency guarantees. Use when designing distributed transactions, handling distributed transactions, or ensuring consistency across services. Triggers: "distributed transactions", "design distributed-transactions", "implement distributed-transactions", "distributed distributed-transactions".
---
...
- Working on distributed transactions tasks
- Reviewing or improving existing distributed transactions implementations
- Troubleshooting issues related to distributed transactions
- Setting up or configuring distributed transactions from scratch
