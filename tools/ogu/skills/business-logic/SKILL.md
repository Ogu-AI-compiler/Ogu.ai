---
name: business-logic
description: Business logic expertise for building robust, scalable backend services and APIs. Use when implementing business logic, designing APIs, or building server-side features. Triggers: "business logic", "implement business logic", "build business-logic", "backend business-logic".
---
...
- Working on business logic tasks
- Reviewing or improving existing business logic implementations
- Troubleshooting issues related to business logic
- Setting up or configuring business logic from scratch
