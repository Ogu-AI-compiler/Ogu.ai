...
description: Pattern selection expertise for building robust, scalable backend services and APIs. Use when implementing pattern selection, designing APIs, or building server-side features. Triggers: "pattern selection", "implement pattern selection", "build pattern-selection", "backend pattern-selection".
---
...
- Working on pattern selection tasks
- Reviewing or improving existing pattern selection implementations
- Troubleshooting issues related to pattern selection
- Setting up or configuring pattern selection from scratch
