---
name: state-machines
description: State machines expertise for building robust, scalable backend services and APIs. Use when implementing state machines, designing APIs, or building server-side features. Triggers: "state machines", "implement state machines", "build state-machines", "backend state-machines".
---
...
- Working on state machines tasks
- Reviewing or improving existing state machines implementations
- Troubleshooting issues related to state machines
- Setting up or configuring state machines from scratch
