...
description: System integration expertise for building robust, scalable backend services and APIs. Use when implementing system integration, designing APIs, or building server-side features. Triggers: "system integration", "implement system integration", "build system-integration", "backend system-integration".
---
...
- Working on system integration tasks
- Reviewing or improving existing system integration implementations
- Troubleshooting issues related to system integration
- Setting up or configuring system integration from scratch
