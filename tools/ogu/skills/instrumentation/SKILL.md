...
description: Instrumentation expertise for building robust, scalable backend services and APIs. Use when implementing instrumentation, designing APIs, or building server-side features. Triggers: "instrumentation", "implement instrumentation", "build instrumentation", "backend instrumentation".
---
...
- Working on instrumentation tasks
- Reviewing or improving existing instrumentation implementations
- Troubleshooting issues related to instrumentation
- Setting up or configuring instrumentation from scratch
