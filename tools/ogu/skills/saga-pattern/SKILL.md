---
name: saga-pattern
description: Saga pattern expertise for building reliable distributed systems with strong consistency guarantees. Use when designing saga pattern, handling distributed transactions, or ensuring consistency across services. Triggers: "saga pattern", "design saga-pattern", "implement saga-pattern", "distributed saga-pattern".
---
...
- Working on saga pattern tasks
- Reviewing or improving existing saga pattern implementations
- Troubleshooting issues related to saga pattern
- Setting up or configuring saga pattern from scratch
