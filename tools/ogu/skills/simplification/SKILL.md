---
name: simplification
description: Simplification expertise for building robust, scalable backend services and APIs. Use when implementing simplification, designing APIs, or building server-side features. Triggers: "simplification", "implement simplification", "build simplification", "backend simplification".
---
...
- Working on simplification tasks
- Reviewing or improving existing simplification implementations
- Troubleshooting issues related to simplification
- Setting up or configuring simplification from scratch
