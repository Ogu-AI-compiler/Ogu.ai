---
name: rate-limiting
description: Rate limiting expertise for building robust, scalable backend services and APIs. Use when implementing rate limiting, designing APIs, or building server-side features. Triggers: "rate limiting", "implement rate limiting", "build rate-limiting", "backend rate-limiting".
---
...
- Working on rate limiting tasks
- Reviewing or improving existing rate limiting implementations
- Troubleshooting issues related to rate limiting
- Setting up or configuring rate limiting from scratch
