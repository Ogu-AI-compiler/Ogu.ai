...
description: Circuit breakers expertise for building robust, scalable backend services and APIs. Use when implementing circuit breakers, designing APIs, or building server-side features. Triggers: "circuit breakers", "implement circuit breakers", "build circuit-breakers", "backend circuit-breakers".
---
...
- Working on circuit breakers tasks
- Reviewing or improving existing circuit breakers implementations
- Troubleshooting issues related to circuit breakers
- Setting up or configuring circuit breakers from scratch
