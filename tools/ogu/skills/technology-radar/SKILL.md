...
description: Technology radar expertise for building robust, scalable backend services and APIs. Use when implementing technology radar, designing APIs, or building server-side features. Triggers: "technology radar", "implement technology radar", "build technology-radar", "backend technology-radar".
---
...
- Working on technology radar tasks
- Reviewing or improving existing technology radar implementations
- Troubleshooting issues related to technology radar
- Setting up or configuring technology radar from scratch
