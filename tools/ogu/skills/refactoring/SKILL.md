---
name: refactoring
description: Refactoring expertise for building robust, scalable backend services and APIs. Use when implementing refactoring, designing APIs, or building server-side features. Triggers: "refactoring", "implement refactoring", "build refactoring", "backend refactoring".
---
...
- Reviewing or improving existing refactoring implementations
- Troubleshooting issues related to refactoring
- Setting up or configuring refactoring from scratch
