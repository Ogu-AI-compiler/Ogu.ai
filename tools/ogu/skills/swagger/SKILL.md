---
name: swagger
description: Swagger expertise for building robust, scalable backend services and APIs. Use when implementing swagger, designing APIs, or building server-side features. Triggers: "swagger", "implement swagger", "build swagger", "backend swagger".
---
...
- Working on swagger tasks
- Reviewing or improving existing swagger implementations
- Troubleshooting issues related to swagger
- Setting up or configuring swagger from scratch
