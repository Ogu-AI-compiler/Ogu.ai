...
description: Systems programming expertise for low-level systems programming, embedded development, and performance-critical code. Use when implementing systems programming, working with hardware interfaces, or optimizing system-level code. Triggers: "systems programming", "implement systems-programming", "systems systems-programming", "low-level systems-programming".
---
...
- Working on systems programming tasks
- Reviewing or improving existing systems programming implementations
- Troubleshooting issues related to systems programming
- Setting up or configuring systems programming from scratch
