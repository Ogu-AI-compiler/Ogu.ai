...
description: Waste elimination expertise for building robust, scalable backend services and APIs. Use when implementing waste elimination, designing APIs, or building server-side features. Triggers: "waste elimination", "implement waste elimination", "build waste-elimination", "backend waste-elimination".
---
...
- Working on waste elimination tasks
- Reviewing or improving existing waste elimination implementations
- Troubleshooting issues related to waste elimination
- Setting up or configuring waste elimination from scratch
