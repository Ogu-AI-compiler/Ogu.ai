...
export async function run({ dir }) {
  ...
  if(v.length)return{pass:false,code:'DS009',message:`${v.length} TODO/FIXME/HACK comment(s) found`,detail:v.join('\n')};
  return{pass:true,code:'DS009',message:'No TODO/FIXME/HACK comments found'};
}
