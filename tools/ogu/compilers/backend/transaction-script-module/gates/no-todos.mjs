...
export async function run({ dir }) {
  ...
  if(v.length)return{pass:false,code:'TX006',message:`${v.length} TODO/FIXME/HACK comment(s) found`,detail:v.join('\n')};
  return{pass:true,code:'TX006',message:'No TODO/FIXME/HACK comments found'};
}
