...
/**
 * MM007 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in model monitoring code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'MM007', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
