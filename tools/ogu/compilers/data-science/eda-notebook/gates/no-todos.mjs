...
/**
 * EN009 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in EDA notebook code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'EN009', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
