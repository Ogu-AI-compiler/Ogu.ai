...
/**
 * ST009 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in statistical test code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'ST009', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
