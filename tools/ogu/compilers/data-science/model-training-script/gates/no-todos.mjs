...
/**
 * MT009 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in model training code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'MT009', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
