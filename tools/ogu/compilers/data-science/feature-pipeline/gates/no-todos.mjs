...
/**
 * FP009 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in feature pipeline code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'FP009', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
