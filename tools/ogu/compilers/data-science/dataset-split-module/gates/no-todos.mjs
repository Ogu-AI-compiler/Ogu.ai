...
/**
 * SP008 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in dataset split code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'SP008', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
