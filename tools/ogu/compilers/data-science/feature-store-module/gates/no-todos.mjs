...
/**
 * FS006 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in feature store code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'FS006', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
