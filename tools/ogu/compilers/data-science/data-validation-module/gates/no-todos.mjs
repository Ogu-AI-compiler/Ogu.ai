...
/**
 * DV007 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in data validation code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'DV007', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
