...
/**
 * AB008 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in A/B test analysis code.
 *
 * Why:
...
export async function run({ dir }) {
  const EXT = ['.py', '.json', '.yaml', '.yml', '.ipynb'];
  ...
  return { pass: true, code: 'AB008', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
