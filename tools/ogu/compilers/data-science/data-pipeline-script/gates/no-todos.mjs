...
/**
 * DP009 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in data pipeline code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'DP009', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
