...
/**
 * DI008 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in data ingestion code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'DI008', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
