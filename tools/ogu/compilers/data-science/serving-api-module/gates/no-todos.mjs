...
/**
 * SA009 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in serving API code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'SA009', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
