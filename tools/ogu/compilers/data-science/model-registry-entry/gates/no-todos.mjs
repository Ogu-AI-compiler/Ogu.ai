...
/**
 * MR008 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in model registry code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'MR008', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
