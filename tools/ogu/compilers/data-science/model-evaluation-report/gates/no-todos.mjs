...
/**
 * ME009 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in model evaluation code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'ME009', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
