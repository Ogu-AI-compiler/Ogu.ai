...
/**
 * EC007 — no-todos
 * Prohibits TODO, FIXME, HACK, and XXX markers in experiment configuration code.
 *
 * Why:
...
export async function run({ dir }) {
  ...
  return { pass: true, code: 'EC007', message: `No TODO/FIXME/HACK markers in ${files.length} file(s)` };
}
