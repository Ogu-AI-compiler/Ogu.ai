...
/** VE005 — no-todos: no TODO/FIXME/HACK in policy files or source code in this artifact directory */
export async function run({ dir }) {
  ...
  if (files.length === 0) {
    return { pass: true, code: 'VE005', message: 'No files found — gate skipped', skipped: true };
  }
  ...
  return { pass: true, code: 'VE005', message: `No TODO/FIXME/HACK (${files.length} file(s) scanned)` };
}
