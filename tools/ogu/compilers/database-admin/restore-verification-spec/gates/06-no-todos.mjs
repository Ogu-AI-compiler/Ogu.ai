...
/** RVS006 — no-todos: no TODO/FIXME/HACK in restore verification spec files */
export async function run({ dir }) {
  ...
  if (files.length === 0) {
    return { pass: true, code: 'RVS006', message: 'No files found — gate skipped', skipped: true };
  }
  ...
  return { pass: true, code: 'RVS006', message: `No TODO/FIXME/HACK (${files.length} file(s) scanned)` };
}
