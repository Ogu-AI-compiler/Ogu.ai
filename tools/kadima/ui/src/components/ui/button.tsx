...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        default: "bg-text text-bg hover:bg-white",
        destructive: "bg-error text-white hover:bg-error/80",
        outline: "border border-border bg-transparent text-text-secondary hover:bg-bg-card-hover hover:text-text",
        secondary: "bg-bg-elevated text-text-secondary hover:bg-bg-card-hover hover:text-text",
